...
function populateReleaseNotes() {
    $.ajax({
        url: 'https://github.com/Juloass/EonTales-Launcher/releases.atom',
        success: (data) => {
...
function populateSettingsUpdateInformation(data) {
    if (data != null) {
        ...
        if (process.platform === 'darwin') {
            settingsUpdateButtonStatus('Download from GitHub<span style="font-size: 10px;color: gray;text-shadow: none !important;">Fermez le Launcher et lancez le .dmg pour mettre à jour.</span>', false, () => {
